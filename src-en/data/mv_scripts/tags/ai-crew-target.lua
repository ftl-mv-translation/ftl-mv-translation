...
table.insert(weaponTagParsers, function(weaponNode)
    local crewTargetNode = weaponNode:first_node("mv-aiCrewTarget")
...
script.on_internal_event(Defines.InternalEvents.PROJECTILE_FIRE, function(projectile, weapon)
    ...
    if weapon.iShipId == 1 and playerShip and crewTargetType and weapon.blueprint.typeName ~= "BURST" then
