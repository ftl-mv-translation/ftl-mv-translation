...
tutM:add_event("tutorial_toggle_2", TutorialEvent.new(
    function()
        table.insert(tutM.textBoxes, TextBox.new(Hyperspace.Text:GetText("tutorial_toggle_2"), 970, 10, false))
    end,
    function()
        checkToggle = false
...
tutM:add_event("tutorial_map_immune_beacon", TutorialEvent.new(
    function()
        ...
        table.insert(tutM.textBoxes, TextBox.new(Hyperspace.Text:GetText("tutorial_map_immune_beacon_jump"), 850, 20, false))
